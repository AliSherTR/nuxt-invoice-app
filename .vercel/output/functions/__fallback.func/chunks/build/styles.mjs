...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.rVoaUHld.mjs').then(interopDefault),
  ...
  "layouts/dashboard.vue?vue&type=script&setup=true&lang.ts": () => import('./dashboard-styles.RvCjnnvS.mjs').then(interopDefault),
  "layouts/auth.vue?vue&type=script&setup=true&lang.ts": () => import('./dashboard-styles.RvCjnnvS.mjs').then(interopDefault)
};
