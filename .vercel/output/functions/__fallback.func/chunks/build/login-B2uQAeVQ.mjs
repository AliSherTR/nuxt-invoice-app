...
import { L as LoginFormSchema, _ as _sfc_main$4, a as _sfc_main$2$1, b as _sfc_main$5, c as _sfc_main$3, d as _sfc_main$1$1, u as useFormField } from './Input-DU6TCW-2.mjs';
import { _ as _sfc_main$6, c as cn } from './index-BOrwQv3i.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div><h1 class="text-2xl font-semibold mb-4">Invoicify</h1><p class="text-sm dark:text-gray-300 text-black mb-6"> Enter your credentials to sign in. </p><form class="space-y-4">`);
      ...
      _push(ssrRenderComponent(unref(_sfc_main$6), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(isLoading) ? "Logging In" : "Login")}`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(isLoading) ? "Logging In" : "Login"), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</form><p class="mt-4 text-sm text-right"> Don&#39;t Have an account? `);
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("features/auth/components/LoginForm.vue");
...
//# sourceMappingURL=login-B2uQAeVQ.mjs.map
